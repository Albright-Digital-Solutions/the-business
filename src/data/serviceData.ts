...
export const services: ServiceEntity[] = [
  // ─── CLEANOUT & CLEARING ───────────────────────────────────────
  {
    ...
    faqs: [
      ...
      { question: 'What happens to usable items during a garage cleanout?', answer: 'Usable furniture, clothing, tools, and household items are sorted and either donated to local Austin-area charities, resold, or recycled. Our goal is to keep as much as possible out of the landfill through our Zero-Landfill Initiative.' },
